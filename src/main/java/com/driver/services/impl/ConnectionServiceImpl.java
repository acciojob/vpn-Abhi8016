        ...
        if(user.getMaskedIp()!=null)
            ...
            for(ServiceProvider serviceProvider:providers){
                ...
                for (Country country:countryList){
                    ...
                    if(countryName.equalsIgnoreCase(country.getCountryName().toString()) && value >serviceProvider.getId()){
                        value =serviceProvider.getId();
            ...
            if(serviceProvider1!=null){
                ...
                int providedId = serviceProvider1.getId();
                String masked = countryCode + "." + providedId +"."+ userId;
